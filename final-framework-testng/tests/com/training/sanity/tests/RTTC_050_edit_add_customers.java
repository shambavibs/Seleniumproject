/*Admin to edit Customer details & add reward points*/
...
package com.training.sanity.tests;
	...
	import com.training.pom.RTTC_050_pom_customers;
	...
	public class RTTC_050_edit_add_customers {
		...
		private RTTC_050_pom_customers dashboard;
		...
		public void setUp() throws Exception {
			...
			dashboard = new RTTC_050_pom_customers(driver);
			// open the browser 
			driver.get(baseUrl);
		}
	@AfterMethod
